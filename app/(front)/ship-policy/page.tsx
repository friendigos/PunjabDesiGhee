...
export default async function ShippingPolicy() {
  return (
    <div className="container my-10 mx-auto md:px-6">
      ...
      Punjab Desi Ghee collaborates with multiple courier partners for shipping across India. We only have standard shipping available at the moment. Depending on the location, it takes 2-9 days to be delivered. We accept orders only from India. Punjab Desi Ghee reserves the right to cancel an order within 48 hours from the time of order.
      </p>
    </div>
  )
}
