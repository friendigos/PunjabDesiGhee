            ...
            <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              <div className="flex flex-wrap items-center">
                <div className="hidden shrink-0 grow-0 basis-auto lg:pl-5 lg:flex lg:w-6/12 xl:w-4/12">
                  <Image
                    src="/images/ghee_photo/aboutus.jpg"
                ...
                <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
                  <div className="px-6 py-12 md:px-12">
                    ...
                    Welcome to our Punjab Desi Ghee family! Our journey began with a deep-rooted passion for bringing the rich, traditional flavors of India to your kitchen. We are dedicated to producing the finest quality ghee, using only the purest ingredients and age-old methods that honor the rich cultural heritage of Punjab.

Our ghee is made from the milk of cows that are nurtured and cared for in the lush green pastures of Punjab. We believe in the power of nature and strive to ensure that our cows are raised in the most natural and humane environment possible. This dedication to nature and animal welfare is at the heart of everything we do.

At the core of our brand is a commitment to the Indian people and their culinary traditions. We understand the importance of ghee in Indian cuisine and culture, and we are proud to provide a product that is not only delicious but also nourishing and authentic.
                    </p>
