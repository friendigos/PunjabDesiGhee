...
export const metadata: Metadata = {
  ...
  description: `Nani's Bilona Ghee Terms of Service: A Clear Agreement for a Delicious Journey.`,
}
  ...
  return (
    <div className="container my-10 mx-auto md:px-6">
      ...
      <p className="text-[#1b2528] text-sm md:text-base">
        ...
        shall NANI&apos;S BOLONA GHEE, our directors, officers, employees,
      ...
      <p className="text-[#1b2528] text-sm md:text-base">
        You agree to indemnify, defend and hold harmless NANI&apos;S BILONA GHEE
