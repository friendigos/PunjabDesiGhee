...
export default async function RefundPolicy() {
  return (
    <div className="container my-10 mx-auto md:px-6">
      ...
      At Punjab Desi Ghee, we take great pride in the quality of our products. Due to the nature of our items, we do not offer refunds. All sales are final.

If you have any questions or concerns about your purchase, please contact our customer support team. We are here to assist you and ensure you have the best experience possible with our products.
      </p>
